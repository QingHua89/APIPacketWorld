...
public class Envio {
    ...
    public Envio(int idEnvio, String guia, int idCliente, int idSucursal, double costo, int idEstadoEnvio, String estado, String nombreCliente, String sucursal, String apPaternoCliente, String apMaternoCliente, String calleCliente, String cpCliente, String sucursalCalle, String sucursalCP) {
